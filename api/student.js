...
Then, provide an originality analysis and a structural plagiarism check. DO NOT generate questions.
Be extremely fast and concise. Output JSON in Korean.
**Rules:** For structural plagiarism, use internal knowledge, NOT web search. Do NOT flag generic formats. Respond with a VALID JSON object without markdown.
**JSON STRUCTURE:**
{
...
Based on the user's text, generate three insightful and probing questions to help them think more deeply.
The questions should be relevant to the text's content.
    ...
    try {
        ...
        if (stage === 'analyze') {
            ...
            finalResultJson = {
                ...
                plagiarismReport: { ...textualJson.plagiarismReport, structuralPlagiarism: conceptualJson.structuralPlagiarism || [] }
            };
